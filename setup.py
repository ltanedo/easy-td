...
setup(
  ...
  packages = ['__endpoints__','__utility__'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/ltanedo/easy-td/archive/refs/tags/v_01.tar.gz',    # I explain this later on
